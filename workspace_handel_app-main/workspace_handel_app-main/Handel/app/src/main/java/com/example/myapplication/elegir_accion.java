...
public class elegir_accion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOpcionCL=(Button) findViewById(R.id.opcionCliente);
        ...
        btnOpcionCL.setOnClickListener(corkyListener3);
    }
    ...
    private View.OnClickListener corkyListener3= new View.OnClickListener(){
        public void onClick(View v){
            Intent pantallaCreate = new Intent(getApplicationContext(), OpcionCliente.class);
            startActivity(pantallaCreate);
        }
    };
}